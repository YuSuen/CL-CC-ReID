...
class LTCC(object):
    ...
    def __init__(self, root='data', **kwargs):
        ...
        train, num_train_pids, num_train_imgs, num_train_clothes, pid2clothes, num_train_cams = \
